...
temp1 <- lm(mhi_CO2$mean_income ~ prediction_datasets[[1]]$co2)
#summary(temp1)
summary(temp1)$r.squared

rList = list()

for(i in seq_len(n_sims)) {
  temp2 <- lm(mhi_CO2$mean_income ~ prediction_datasets[[i]]$co2)
  rList <- append(rList, summary(temp2)$r.squared)
}
